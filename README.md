...
## 조직 (요약)
- **전체 등록 AI 직원 11명**. 단일 기준은 `ops/playbooks/operating-model.md`.
- **08:00**: 보고 자동화가 열린 PR만 요약. 직원 작업 시간이 아님.
- **매일 09:00**: 제품개선 5명(CEO·기획·개발·검사·기록) → 앱 1개 개선 PR.
- **매일 09:30**: 홍보 1명 → 콘텐츠 초안 PR.
- **주간**: 개선 엔진 3명(감독·R&D·릴리즈).
- **월간**: 전략·설계 2명.
...
## 버전
- 시스템 버전: `VERSION` (현재 0.2.9) — 회사 운영 방식/자동화 변경 시 bump.
