...
export default function NoteBomPrivacy() {
  return <AppPrivacyPage app={{
    ...
    local: "원음 조각, 제목, 기기 내 Whisper가 만든 인식 원문, 수정본, 템플릿과 설정은 기본적으로 사용자의 브라우저 IndexedDB에 저장됩니다. 기본 자동 변환 중 원음은 서버로 업로드되지 않습니다. 현재 로그인·서버 동기화·광고 추적을 운영하지 않으며, 사용자가 전체 원음 백업을 직접 내보내고 복원할 수 있습니다.",
