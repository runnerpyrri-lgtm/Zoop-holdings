...
## robom 브랜드 사이트 (2026-07-11)
- [x] 한쪽 안경을 쓴 로봄 캐릭터 제작·투명 배경 검증
- [x] 화사하고 따뜻한 반응형 회사 홈페이지 구현
- [x] `로봄 robom` 워드마크와 세 앱 포트폴리오 연결
- [x] 로컬 브라우저 데스크톱·모바일 검증
- [ ] draft PR 생성 후 회장 승인·머지
