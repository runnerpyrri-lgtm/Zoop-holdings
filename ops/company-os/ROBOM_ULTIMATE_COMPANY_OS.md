# ROBOM ULTIMATE COMPANY OS
## 로봄 궁극의 제품 개발·계열사 관리·AI 회사 운영·12개월 자율운영 마스터 프롬프트

**Prompt Version: 1.2.0**
**Compatibility: Codex Ultra · Claude Code · 동급 자율 코딩 에이전트**
...
```text
1. 실행 시점의 실제 Production 동작과 운영 증거
...
문서 맨 위의 `Prompt Version`이 사용자가 최신본을 구별하는 유일한 표시다.
...
→ CURRENT DIRECTIVE와 PRODUCT PROFILE 구성
→ 영향 범위·위험 등급
→ 필요한 실행 Level 선택
→ 증상·핵심 흐름 재현
