...
2. `robom-company-hub` 스킬과 휴대 사용자 지침을 읽는다.
3. `PROTOCOL.md`, `COMPANY-MODE.md`, 해당 방 `PROMPT-CODEX.md`를 읽는다.
4. 비공개 회의록의 상대 AI 새 기록을 읽는다.
5. 관련 등록부·운영 상태·대상 저장소·PR·배포를 확인한다.
