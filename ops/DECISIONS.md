...
## 2026-07-10 · 운영 정합성 정리

### D13. 직원 수·팀 배치·보고 기준 단일화
- 결정: 전체 등록 AI 직원은 11명으로 설명한다. 매일 기본 가동은 제품개선 5명(09:00) + 홍보 1명(09:30), 주간 관리는 3명, 월간/TF는 2명이다.
- 결정: 08:00은 직원 작업 시간이 아니라 보고 자동화 시간이다.
- 결정: 정기 보고에는 사람이 확인할 열린 PR만 넣고, 완료된 PR 번호는 제외한다.
- 적용: `ops/playbooks/operating-model.md`를 단일 기준으로 추가하고, `guardrails.yml`에 운영 정합성 검사를 연결한다.
