...
직원 수·팀 배치·시간표의 단일 기준은 `ops/playbooks/operating-model.md`다.
...
- 기본 보고 문구는 아래 기준으로 통일한다.
  ...
  - 전체 등록 AI 직원은 **11명**.
  - 실제 매일 작업팀은 **09:00 제품개선 5명**(CEO/기획/개발/검수/기록) + **09:30 홍보 1명**.
...
• 전체 등록 직원: 11명
• 08시: 보고 자동화가 상태 알림
• 09시: 제품개선 5명(CEO/기획/개발/검수/기록)
• 09시30분: 홍보 1명(콘텐츠 초안, 외부 게시는 사람 승인)
• 주간/월간: 감독·개선·릴리즈·전략·설계는 정기 점검 때만
