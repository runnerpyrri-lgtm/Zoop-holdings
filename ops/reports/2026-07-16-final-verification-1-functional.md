...
다섯 앱의 핵심 과업, 저장 데이터, 알림 제한 안내, 공식 데이터 fallback, 패밀리 연결과 광고 OFF 상태를 다시 검사했다. P0·P1과 수정 가능한 P2 미해결은 0건이며 사용자 저장 데이터 초기화나 핵심 기능 회귀는 발견되지 않았다.
...
| 자격증봄 | 0.6.0 | `69478f8d867ff0525d376f53f731a9d17a9dafb9` | 시험 97개·일정 보유 70개·현재 접수 우선·3+7·관심 시험·캘린더 유지 | PASS |
...
- 자격증봄은 typecheck·Biome lint·30개 unit·production build·36개 E2E가 통과했다. CI run `29467843024`, family run `29467843292`이 성공했다.
